...
def weather_helper():
    ...
    temp = int(input("Please enter the current temperature in degrees Fahrenheit"))
    ...
    if temp < 40:
        ...
        ac = input("Do you have air conditioning? ").lower()
        if ac in affirmative:
